...
class Db
{
     ...
     */
    function __construct($useA)
    {
        if ($useA == false){
            $this->DATABASENAME = 'fincode_internal';
        }
    ...
    {
        $conn = new \mysqli(self::HOST, self::USERNAME, self::PASSWORD, $this->DATABASENAME);
